...
class NymphoScraper:
    def __init__(self):
        self.base_url = 'https://tour.nympho.com'
        self.data_dir = './data/'
    ...
    def scrape_website(self):
        ...
        while True:
            ...
            for div in scene_divs:
                ...
                movie_data = {"Title": title, "Duration": duration, "Website": "Nympho"}
...
if __name__ == "__main__":
    scraper = NymphoScraper()
    scraper.scrape_website()
    print("Scraping complete. Data appended to CSV files in ./data directory.")